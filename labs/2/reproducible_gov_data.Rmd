...
This should be complete by the beggining of class on Thursday, Jan 19.

# Instructions
- using a data set from data.gov make diffent **three** plots using ggplot.
- include an explaination of what each plot tells you
