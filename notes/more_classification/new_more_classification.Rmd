...
b) a packages in R (and Python and many other languages) so that us data scientists don't have to learn C to aforementioned C implementation of SVM
...
## Non-linear Variable Transformation
