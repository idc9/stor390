...
A few people took the time to type up the scripts for a number of Disney movie scripts: [http://www.fpx.de/fp/Disney/Scripts/](http://www.fpx.de/fp/Disney/Scripts/). This lecture will use the script for Beauty and the Beast. 
