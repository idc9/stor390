...
To run the code on your computer download [this .zip file](https://github.com/idc9/stor390/blob/master/notes/shiny/stor390_Shiny.zip), open `shiny.Rmd` in R Studio then click `Run Document`.
