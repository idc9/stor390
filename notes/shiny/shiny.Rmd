...
To run the code on your computer download [this .zip file](https://github.com/idc9/stor390/blob/master/notes/shiny/stor390_Shiny.zip), open `shiny.Rmd`, then click `Run Document`. *Warning*: you have to run the code from the .zip file to get the apps in this lecture to work.
