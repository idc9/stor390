...
generate dynamic UI, i.e. construct reactive objects that depend user input. 
...
to dynamically generate this `selectInput` inside `renderUI` (on **server** side)
...
![Basic app layout](shiny_layout.png)
...
![Basic app layout with tabsets](shiny_tabsets.png)
...
![shinydashboard](shinydashboard_filled.png)
