...
## Burpee Calculator
## ui.R
#Start with calories per burpee
...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            numericInput('Weight', "Input your Weight (lbs)", 0, min=100, max=250, step=10),
            numericInput('Quantity', "Number of Glasses (12 oz.)", 1, min=1, max=10, step=1),
            selectInput('Beer', "Type of Beer Consumed:",
                        list("Amstel Light",
                             "Anchor Steam",
        ...
        mainPanel("",
                  ...
                  verbatimTextOutput("Cal_Beer"),
                  h4('Number of Burpees needed to offset beer consumption:'),
                  verbatimTextOutput("burpees"),
                  h3('How to Perform Burpees:'),
                  img(src="BurpeeImage.png", height = 400, width = 400),
                  p("Sources:"),
