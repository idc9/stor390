...
Can your iPhone tell what you are doing based on your physical motion i.e. using only the [accelerometer](http://electronics.howstuffworks.com/iphone-accelerometer.htm) and [gyroscope](https://en.wikipedia.org/wiki/Gyroscope)?


Researchers collected data from 30 volunteers performing 6 activities: walking, walking upstairs, walking downstairs, sitting, standing, laying. The original data set and details about the covariates can be [found here](https://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones) from the UCI machine learning repository.
...
# k values to use
k_values <- seq(from=1, to= 41, by=4)
