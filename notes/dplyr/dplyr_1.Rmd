...
If you have not yet intalled tidyverse go ahead and do so
...
We discussed setting working directories in the [last lecture](https://idc9.github.io/stor390/notes/workflow/workflow.html). The code in this leture assumes the data set and R code are in the same directory.
...
In *R*, for reasons we won't talk about, you want to avoid creating lots of unnecesary objects in your environment. Using pipes help you do that.
...
- return a list of grouing variables from a grouped data frame using `groups(data frame)`
...
Why bother with this bonus secton?
...
We can combine the grouped mutate and summarise operations to learn **average number of weeks between observations per species.**
