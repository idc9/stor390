...
- add more deatils about CSS tags and possible more about HTML
- come up with scraping lab
- fix the tags so they display literally
...
We could get rid of some duplicates if we were so inclined using some combination of heuristic deduplication rules (e.g. flag every song whose title contains another song's title) and manual inspection[^4].
...
----
[^1]: I got myself (and everyone at Open Eye cafe) banned the first time I tried to do this.

[^2]: Why would one want a 'light weight' markup langauge?

[^4]: Dedubplication is a hard problem -- there are start ups devoted to this task.