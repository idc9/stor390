...
Note: this lecture was created by [David Robinson](http://varianceexplained.org/) for [BIO 260](http://datasciencelabs.github.io/) and borrowed with permission for [STOR 390](https://idc9.github.io/stor390/).
...
```{r, echo=F}
# Hack Iain added to make code run...
# number_helpful[8] <- 0
```
