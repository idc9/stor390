...
You should brainstorm a long list of ideas, the narrow it down to a couple that are feasable given your knowledge of R/the time constraints. Write the proposal for one of these ideas, but you should keep a couple backups in case the original project doesn't work out for some reason.
