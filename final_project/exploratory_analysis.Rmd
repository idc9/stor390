...
Gather everything into one folder called **n_eda** (where n= your group number). This folder should have foud subfolders: **/summary**, **initial_results**, **/everything**, and **/data**. Please zip the **n_eda** folder and email it to the instructor.
