...
* Data scientist at a medical tech company, BD
* Background in statistics (PhD), bioinformatics, and biology
* I know more computing than an average statistician and more stats than an average computer scientist
* Analysis of genomic data - previously single cell RNA-Seq, cancer panels, high throughput sequencing library prep instruments
* Working on 
  - Antimicrobial resistance
    - Use machine learning methods to predict resistance or susceptibility to a specific antibiotic for a bacterial isolate using next generation sequencing of the bacterial DNA
    - Build a PostgreSQL database to store all predictions and related experimental metadata
  - Molecular point-of-care (POC) assays
    - Past few months on Veritor SARS-CoV-2 antigen rapid test
    - Rapid isothermal tests for STIs, Flu A+B, etc 
* Demo of company app



![](screenshots/data_scientist.jpeg){width=50%}


## Data science - some thoughts

![](screenshots/data_scientist_2.png)

* Data extraction, cleaning, organization, and manipulation: 80% of the job is "data janitor"
* Basic statistics: understanding systematic and random error
* <span style="color: red;">Domain expertise: generating the right hypotheses and questions and answering them appropriately</span>
* <span style="color: red;">Communication skills: clear visualizations, explaining things well, actionable results, "managing up", etc</span>
* Ability to learn new things quickly: google-fu
* Please feel free to email me any questions at frances.p.tong@gmail.com




![](screenshots/yoda_googlefu.jpg)


## Ways to meet local data scientists (Pre-Covid Links - some may still be doing virtual meetings)
...
https://www.meetup.com/pro/Data-Science-Connect


* NC Data for Good

https://www.meetup.com/NC-Data4Good



* NC Women in Machine Learning and Data Science

https://www.meetup.com/NC-Women-in-Machine-Learning-and-Data-Science/


* Data Scientista Society

https://www.meetup.com/DataScientistaSociety/


* R-Ladies RTP

https://www.meetup.com/R-Ladies-RTP/

![](screenshots/rladies.png)

## Work-life balance

* Can work entirely from home as long as I have a work laptop and decent internet (and childcare!) and probably will until next fall
* WFH indefinitely is not preferable - my scientist colleagues will tell me more about their projects if I'm there in person, and I can learn more from my data scientist colleagues if I'm sitting near them
* Flexible hours - I only need to make sure I get my work done
* My usual day consists of checking email, attending meetings, and coding in R with RStudio.  (I will use Python if it will get done much better and faster in Python.)
* Sometimes meeting deadlines means super crazy intense work days, late nights, and weekends (i.e. Covid test development), but this doesn't happen all the time


## Topics today - November 11, 2020

This lecture is an introduction to Shiny and contains the basics that you 
already learned at the intro to Shiny lecture that you can reference later if you like.
...
inputPanel(sliderInput(inputId = "bins",
...
The first two arguments to a widget function are always
...
## UI output and server render functions

These are the standard output functions you would use in the **ui**.
...
interact with it.  They are a bit nuanced to use - here's the RStudio tutorial on them https://shiny.rstudio.com/tutorial/written-tutorial/lesson6/. 
...
inputPanel(
  numericInput("lat", "Latitude", value = 35.9107703),
  numericInput("lng", "Longitude", value = -79.051447),
...
You'll notice that it needs a rmarkdown template to fill in the user inputs and compile.  The file `report.Rmd` looks like the following - the header includes R chunks to fill in the author and date.  Put this file in the same directory as your shiny app.
    ...
    server = function(input, output) {
        ...
        output$report <- downloadHandler(
            ...
            content = function(file) {
                ...
                out <- rmarkdown::render(markdownFile, 
                                         switch(
                                             input$format,
...
* Note that you'll need to install the TeX engine to produce pdfs.
- Macs: https://tug.org/mactex/mactex-download.html
...
You can also use the power of Shiny in your everyday analysis within RStudio.
A great example is being able to select points in your plot of any dataset
and have it saved in the console.  These Shiny based tools are called gadgets.

[https://shiny.rstudio.com/articles/gadgets.html](https://shiny.rstudio.com/articles/gadgets.html)

![](screenshots/gadget.png)


## Shiny gadgets example

1. Make a function that has the same `ui` and `server` parts as a regular app but use the miniUI package with `miniPage`, `miniContentPanel`, `gadgetTitleBar` functions instead for better gadget capabilities inside RStudio.
...
2. Source the function in the console.

3. Call the function on data.
