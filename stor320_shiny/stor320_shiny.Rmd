...
* PhD in statistics
* Data scientist at a medical tech company
...
* Domain expertise: generating the right hypotheses and questions and answering them appropriately
* Communication skills: clear visualizations, explaining things well, etc
...
## Ways to meet local data scientists (Pre-Covid Links)
...
and have it saved in the console.  These Shiny based tools are called gagdets.
