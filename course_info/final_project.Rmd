...
Start with a question. Find data that might get at that question. Play around with the data. Iterate. Communicate.
...
Your project should have an upshot to it (e.g. ""). It should not just be a collection of plots/numbers about a dataset.


# Groups

You will work in groups of K people, assigned by the instructor. See grading details below and [the group work policies document]().

# Final deliverables

There are two final deliverables which will be posted as [Github pages](https://pages.github.com/): a blog post and the analysis code/data. The final project is due Tuesday May 9th at 4:00pm.

## Blog post

Write a blog post in R Markdown aimed at a general audience (think [538](https://fivethirtyeight.com/)).

- should be TODO words
...
Your data set (both raw and processed) should be posted to github as well. See [instructions for creating a github page]() (coming soon...).

# Where to find data?

You can find a seriously large amount of data online. I encourage you to "gather your own data online" by doing something like [scraping Twitter]() (I don't beg your friends to take a survey, although you could...).
...
http://josh-jacobson.github.io/genre-classification/
