...
- learn core R programming skills (see first three sections of R for Data Science)
    - visualization
    - data manipulation
    - data import/acquisition
    - if/else, for/while loops, functions
    - regular expressions, dates/times, relational data, web scraping

- utilize programming and statistical best practices i.e. comment code, identify possible sources of biases

- learn technical communication skills
    - [R Markdown](http://rmarkdown.rstudio.com/)
    - [shiny](http://shiny.rstudio.com/) for interactive visualization
    - effective visual communication (hint: do less, not more!)
    
- practice professional skills: communication, creative thinking, critical thinking, self-directed learning, and teamwork 
...
# Textbooks
We will follow [R for Data Science](http://r4ds.had.co.nz/) by Hadley Wickham (free online). 
...
Some topics may be supplemented by [Introduction to Statistical Learning with Applications in R](http://www-bcf.usc.edu/~gareth/ISL/) by Tibshirani et al. (also free online)
...
[R Programming for Data Science](https://leanpub.com/rprogramming) by Roger Peng is a useful alternate (free) textbook for learning R
...
- Programming i.e. functions, loops, if/else, comments (RDS ch 4, 6, 17, 19, 20)
- Tidy data, relational data and data import (RDS ch 11-13)
- Strings and regular expressions (RDS ch 14)
- Exploratory Data Analysis
- Modeling i.e. classification, clustering and regression
- Web scraping
- Text data and NLP
...
This class will provide a foundation with essential tools, experience working with data and exposure to more advanced topics. We will use concepts from statistics, machine learning and computer science that rely on more advanced math, however, we will not go into depth into these topics. STOR 390 is meant to augment many fantaic exisiting courses such as: probability, theoretical/applied statistics, algorithms, databases etc. Following R for Data Science
...
We will use [Slack](https://slack.com/) for class discussion (think AIM for tech companies). Slack is free and you should download the app onto your computer. We will provide instructions for joinging the slack team in the first class.
...
The **longer assignments** will be end to end data analyses i.e. get, clean, analyze, communicate. Code will be provided to make these managable.

These assigmnets are graded on a 100 point scale and will take into account: statistical rigor, coding accuracy, and communication. Note that communication includes: writing human readable code, clear visualizations and coherent writing. Detailed rubrics will be provided with each assignment. 

Some of these assigmnets will be done in teams (see below for group work policy). One homework may be dropped *if you participate in [DataFest](http://www2.stat.duke.edu/datafest/)*. Assignments handed in late will lose 10 points each day past the due date.
...
- This class may be quite different from other STEM courses you have taken -- particularly the amount of class particiaption. [Active Learning](https://en.wikipedia.org/wiki/Active_learning) is backed up by hundreds of studies that show active learning performs better than traditional lecturing on almost every examined learning outcome (see Felder and Brent below).
...
For labs/group activities you are encouraged to work with other people, however, you are **not allowed to copy someone else's code**. For homeworks you are encouraged to use online resources as long as you **cite a resource you borrow code from**. 

For informal collaborations, such as labs and Slack, you may help each other debug programs and develop approaches to solve a problem, but you should not directly share code. You can post questions about specific parts of a problem on Slack/github if you have made several attempts to solve it. Please do not post the entire solution to a problem -- just answer the specific question being asked.

Please report any significant collaborations (just post names in a comment at the top of a script). We may use software to detect cheating and these reporting collaborations will help prevent false positives. You will be expected to explain your code by your self in class. These policies are based on COMP 401 taught by Ketan	Mayer-Patel.
...
The following books, courses and papers were influential in the design of this course. See the acknowledgements page for a long list of fantastic people who provided lots of input for the class [https://idc9.github.io/stor390/course_info/acknowledgments.html](https://idc9.github.io/stor390/course_info/acknowledgments.html)
...
- [A Guide to Teaching Data Science](https://arxiv.org/pdf/1612.07140v1.pdf) by Stephaie Hicks and Rafael Irizarry
