...
|----------|------|-------------|
| January 12 | [data.gov](labs/gov_data/gov_data.html) | |



# Reading
Readings should be complete by the following class period. r4ds means [R for Data Science](http://r4ds.had.co.nz/).
