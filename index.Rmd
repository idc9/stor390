...
|January 31 |more programming and eda |[more prog](notes/programming/prog_notes.html) and [EDA](notes/EDA/EDA.html)| |
|February 2| tidy data | | |
|February 7| joins | | |
|February 9| | | |
|February 14| | | |
|February 16| | | |
...
- [the tidy and relational data notes]()
...
- read r4ds section 13.5-13.7 ([relational data](http://r4ds.had.co.nz/relational-data.html))


**February 9**
- read r4ds section 14.1-14.2  ([strings](http://r4ds.had.co.nz/strings.html#introduction-8))
...
| January 26 |[prog lab](labs/3/prog_lab.html)  | | |
| January 31 | | | vectors + lists|
| February 2 | tidy data lab| | |
| February 7 |relational data lab| | |
