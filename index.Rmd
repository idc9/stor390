...
- In addition to r4ds there are a number of useful resources for learning R/data scinece listed on the [course references page](course_info/references.html)
...
|January 17 | workflow + ggplot|[**workflow**](notes/workflow/workflow.html) |
