...
- read [chapter 1](http://tidytextmining.com/tidytext.html) of Text Mining with R

**April 18**

- read [chapter 3](http://tidytextmining.com/tfidf.html) from TMR
- (optional) read [chapter 4](http://tidytextmining.com/ngrams.html) from TMR
- read about [stemming and lemmatization](https://nlp.stanford.edu/IR-book/html/htmledition/stemming-and-lemmatization-1.html)


**April 20**

- read [ISLR](http://www-bcf.usc.edu/~gareth/ISL/) sections 10.1, 10.3.1, and 10.3.3 about K-means and clustering
